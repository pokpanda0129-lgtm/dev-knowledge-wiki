...
첫 입장 장면을 떠올려봅니다. CSR 공연장은 처음에 빈 무대판만 보입니다. 잠시 뒤 직원들이 나무 소품을 들고 오고, 울타리를 세우고, 배경막을 펼치고, 버튼 장치까지 하나씩 연결합니다. 관객은 직원들이 무대를 다 꾸밀 때까지 기다려야 제대로 된 장면을 볼 수 있습니다.

반대로 SSR 공연장은 줄 레일에 매달린 무대 세트가 통째로 내려와서 관객은 바로 무대를 볼 수 있습니다. 다만 조명 스위치와 버튼은 눌러도 제대로 작동하지 않아서 직원들이 조명 스위치와 버튼을 연결해줍니다.

이번에는 장면 전환을 떠올려봅니다. SPA 공연장은 같은 무대에서 이미 있는 소품을 먼저 쓰고, 부족한 것만 창고에서 가져와 안쪽 장면을 바꿉니다. MPA 공연장은 장면이 바뀔 때마다 천막이 내려와 무대를 가리고, 그 뒤에서 무대 세트 전체가 새로 바뀝니다.
